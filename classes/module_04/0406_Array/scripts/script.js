...
//  console.log(frutas[2].length); // 2
 ...
 // Aqui está alterando a ordem dos elementos (ele pega o primeiro caracter do elmento  e colcoa em ordem alfabetica, sendo eles string, não funciona com numeros)
 // IMPORTANTE ESSE MÉTODO MODIFICA A ARRAY ORIGINAL
 instrumentos2.sort()
